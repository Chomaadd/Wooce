      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-gradient-to-br from-primary via-primary/80 to-primary/60 items-center justify-center p-12 flex-col">
        ...
        <div className="relative text-center">
          ...
          <div className="mt-10 flex flex-col gap-3 text-left">
            {["Kelola cerita & chapter dengan mudah", "Statistik views & rating real-time", "Upload & crop cover langsung dari browser"].map((item, i) => (
        ...
        <div className="w-full max-w-sm relative">
          ...
          <div className="mb-8">
            <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-primary/10 border border-primary/20 mb-5">
              ...
              <span className="text-[11px] font-bold text-primary uppercase tracking-widest">Autentikasi</span>
            </div>
            ...
            <p className="text-sm text-muted-foreground mt-2">Masuk untuk mengelola portofoliomu.</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              <label htmlFor="username" className="text-xs font-bold uppercase tracking-widest text-muted-foreground block">Username</label>
              <input
                id="username"
                required
            ...
            <div className="space-y-2">
              <label htmlFor="password" className="text-xs font-bold uppercase tracking-widest text-muted-foreground block">Kata Sandi</label>
          ...
          <p className="text-center text-xs text-muted-foreground/40 mt-8 tracking-wider uppercase">
            WOOCE Novel · Admin Panel · {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </div>
