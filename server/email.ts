            ...
            <table cellpadding="0" cellspacing="0" align="center" style="margin:0 auto 16px auto;">
              <tr>
                ...
                <td style="padding:0 7px;">
                  <a href="https://www.tiktok.com/@woocenovel" target="_blank" style="display:block;width:40px;height:40px;background:#111827;border-radius:50%;text-decoration:none;" title="TikTok">
                    <table cellpadding="0" cellspacing="0" width="40" height="40"><tr><td align="center" valign="middle">
                ...
                <!-- Facebook -->
                <td style="padding:0 7px;">
                  <a href="https://www.facebook.com/woocenovel" target="_blank" style="display:block;width:40px;height:40px;background:#1877f2;border-radius:50%;text-decoration:none;" title="Facebook">
                    <table cellpadding="0" cellspacing="0" width="40" height="40"><tr><td align="center" valign="middle">
                      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="#ffffff">
                ...
                <!-- Instagram -->
                <td style="padding:0 7px;">
                  <a href="https://instagram.com/woocenovel" target="_blank" style="display:block;width:40px;height:40px;background:#c13584;border-radius:50%;text-decoration:none;" title="Instagram">
                    <table cellpadding="0" cellspacing="0" width="40" height="40"><tr><td align="center" valign="middle">
                      <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="#ffffff">
